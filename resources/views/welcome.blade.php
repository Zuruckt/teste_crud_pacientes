    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                , success: function(data) {
                    $.each(data, function(i, data) {
                        ...
                        body += '<td><button class="btn btn-warning" onclick="return updatePacient(' + data.id + ');""><i class="fas fa-pen"></i></button></td>'
            ...
            $('#profile_photo').change(function(event) {
                form_data = new FormData(document.querySelector('#post-pacient-form'));
                form_data.append('profile_photo', event.target.files[0]);
            });
            ...
            $("#post-pacient-form").validate($params);
        });
